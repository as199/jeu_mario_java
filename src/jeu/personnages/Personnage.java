...
public class Personnage {
    ...
    public void deplacement() {		
		if(JeuMario.scene.getxPos() >= 0){this.setX(this.getX() - JeuMario.scene.getDx());}
	}
    
    public Image marche(String nom, int frequence){ //nom du personnage et fr�quence des pas		
    	String str;	
		ImageIcon ico;
		Image img;
